...
<form method="post">
  ...
  <table style="width:100%"; cellspacing="20">
   <tr>
     <td><img src="myBooks.png"alt="My Books" onclickstyle="width:304px;height:228px;" onclick="location.href='reload.html'"></td>
    ...
    <tr>
     ...
     <td><img src="wishlist.png"alt="Wishlist" onclickstyle="width:304px;height:228px;" onclick="location.href='reload.html'"></td>
